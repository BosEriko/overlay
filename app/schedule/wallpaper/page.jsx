...
export default function WallpaperSchedule() {
  return (
    <div className={`${pixelify.className} text-white font-sans flex flex-col fixed top-0 left-0 h-[1080px] w-[1920px] pointer-events-none overflow-hidden`}>
